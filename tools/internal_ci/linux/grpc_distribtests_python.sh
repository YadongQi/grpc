...
tools/run_tests/task_runner.py -f artifact linux python cp37-cp37m aarch64 ${TASK_RUNNER_EXTRA_FILTERS} -j 12 -x build_artifacts/sponge_log.xml || FAILED="true"
...
tools/run_tests/task_runner.py -f package linux python cp37-cp37m aarch64 -x build_packages/sponge_log.xml || FAILED="true"
...
tools/run_tests/task_runner.py -f distribtest linux python cp37-cp37m aarch64 ${TASK_RUNNER_EXTRA_FILTERS} -j 12 -x distribtests/sponge_log.xml || FAILED="true"
